<template>
  <div class="map-three fill">
    ...
    <el-dialog title="图表" :visible.sync="dialogVisible" width="700px" :before-close="handleClose">
      <div
        id="echartMap"
        style="width:100%;height:350px;backgroundColor: #fff"
        v-if="dialogVisible"
      ></div>
    </el-dialog>
  </div>
...
export default {
  ...
  mounted() {
    ...
    requirejs(["/js/mapbox/mapbox-gl_g.js"], mapboxgl => {
